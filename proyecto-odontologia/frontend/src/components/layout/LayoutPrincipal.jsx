...
function obtenerTituloRutaActual(pathname) {
  ...
  if (/^\/panel\/pacientes\/\d+$/.test(pathname)) return "Ficha del paciente";
  if (pathname === "/panel/tratamientos") return "Tratamientos";
  if (/^\/panel\/tratamientos\/\d+$/.test(pathname)) return "Detalle del tratamiento";
  if (pathname === "/panel/pagos") return "Pagos";
  if (pathname === "/panel/gastos") return "Gastos";
  ...
  if (pathname === "/panel/administrador/catalogos") return "Catálogos";
  ...
  */
  ...
  const itemsNav = [
    ...
    },
    {
      ...
      icono: <IconoPagos />,
      texto: "Pagos",
      mostrar: tienePermiso("ver_pagos"),
    },
    {
      a: `${baseRuta}/gastos`,
      icono: <IconoGastos />,
      texto: "Gastos",
      mostrar: tienePermiso("ver_gastos"),
    },
    {
      a: `${baseRuta}/reportes`,
      icono: <IconoReportes />,
  ...
  itemsNav.push({
    a: `${baseRuta}/administrador/catalogos`,
    icono: <IconoCatalogos />,
    texto: "Catálogos",
    mostrar: tienePermiso("ver_catalogos"),
  });
